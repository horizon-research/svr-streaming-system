 ...
 */
public class SerializeRequest<T> extends TCPRequest {
     ...
     */
    public SerializeRequest(String host, int port, T serializeObj) {
        super(host, port);
    ...
    public SerializeRequest(ServerSocket ss, T serializeObj) {
        super(ss);
        this.serializeObj = serializeObj;
